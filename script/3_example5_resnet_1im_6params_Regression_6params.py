...
result_dir = os.path.join(current_dir, 'results/3_6params_regression')
...
def main():
    ...
    matplotlib2tikz.save("results/3_6params_regression/regression_1image_6params_{}.tex".format(file_name_extension))
    plt.show()
