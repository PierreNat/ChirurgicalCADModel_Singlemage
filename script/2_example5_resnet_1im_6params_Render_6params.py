...
def main():
    ...
    for i in loop:
        ...
        for image, silhouette, parameter in train_dataloader:
            ...
            if(i == iterations-1):
                ...
                plt.savefig('results/Final_render_6params_{}iterations_{}.png'.format(iterations, file_name_extension),  bbox_inches = 'tight', pad_inches = 0.05)
    ...
    fig.savefig('results/render_1image_6params_{}.pdf'.format(file_name_extension), bbox_inches = 'tight', pad_inches = 0.05)
    fig.savefig('results/render_1image_6params_{}.png'.format(file_name_extension), bbox_inches = 'tight', pad_inches = 0.05)
    matplotlib2tikz.save("results/render_1image_6params_{}.tex".format(file_name_extension))
    plt.show()
